...
Features:
  ...
  - Reflection & mood journaling`;break;default:i=`Command not found: "${t}". Type "help" for available commands.`}u([...a,{type:"output",text:i}])},[x]),$=(0,a.useCallback)(()=>{let e={};(C.name.trim()||(e.name="Name is required"),C.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(C.email)||(e.email="Invalid email"):e.email="Email is required",C.message.trim()||(e.message="Message is required"),Object.keys(e).length>0)?z(e):(z({}),A(!0),setTimeout(()=>A(!1),4e3),S({name:"",email:"",message:""}))},[C]),[G,K]=(0,a.useState)(0);(0,a.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollHeight-window.innerHeight;K(e>0?window.scrollY/e*100:0)};return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)},[]);let Y="All"===f?r:"AI"===f?r.filter(e=>(e.tags||[]).some(e=>e?.toLowerCase()==="openai"||e?.toLowerCase()==="claude ai"||e?.toLowerCase()==="ai")):r.filter(e=>(e.tags||[]).some(e=>e?.toLowerCase()?.includes(f.toLowerCase())));return(0,t.jsxs)("div",{style:{"--bg":"#06080d","--surface":"#0d1117","--card":"#161b22","--card-hover":"#1c2333","--accent":"#3bc7ff","--accent2":"#a485ff","--accent-glow":"rgba(59,199,255,0.15)","--ai-color":"#a485ff","--text-primary":"#e6edf3","--text-secondary":"#8b949e","--border":"rgba(59,199,255,0.1)","--gradient-1":"linear-gradient(135deg, #3bc7ff, #a485ff)","--gradient-2":"linear-gradient(135deg, #a485ff, #ff6b9d)","--nav-bg":"rgba(6,8,13,0.85)"},className:"theme-dark",children:[(0,t.jsx)("style",{children:`
